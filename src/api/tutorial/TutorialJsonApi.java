...
public class TutorialJsonApi {
	...
	public static void streamFile(String json, String tutorial, String section) throws ParseException, IOException {
		...
		try (FileOutputStream fout = new FileOutputStream(resourceUrl.toString())) {
